...
public class AccidentLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mem1phone = (TextView) findViewById(R.id.tv_memphone1Acc);
        mem2phone = (TextView) findViewById(R.id.tv_memphone2Acc);
        ...
        reff.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(AccidentLocationActivity.this, "Error Occured", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        reff.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                if (p) {
                    ...
                    Toast.makeText(AccidentLocationActivity.this, "Error sending sms", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void sendSMS() {
        ...
        String message = "http://www.google.com/maps/place/" + myLatitude + "," + myLongitude;
