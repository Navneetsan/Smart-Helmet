...
public class AlcoholActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mem1phone = (TextView) findViewById(R.id.tv_memphone1Alc);
        mem2phone = (TextView) findViewById(R.id.tv_memphone2Alc);
        ...
        reff.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(AlcoholActivity.this, "Error Occured", Toast.LENGTH_SHORT).show();
            }
        });

        reff = FirebaseDatabase.getInstance().getReference().child("IOT").child("Alcohol");
        ...
        reff.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                String value = dataSnapshot.child("Alcohol time").getValue(String.class);
                boolean p = al1.add("Alcohol Detected On " + value);
                al1.add("");
                ...
                if(p) {
                    ...
                    Toast.makeText(AlcoholActivity.this, "Error sending sms", Toast.LENGTH_SHORT).show();
                }
            }
